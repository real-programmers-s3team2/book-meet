...
function MyInfoMainContainer(){
    return(
        <MiddleContainer>
            <Email>이메일</Email><InputContainer1></InputContainer1>
            <Name>소속</Name><InputContainer2></InputContainer2>
            <Department>부서</Department><InputContainer3></InputContainer3>
            <Pw>비밀번호</Pw><InputContainer4/>
            <ConfirmPw>비밀번호 확인</ConfirmPw><InputContainer5/>
        </MiddleContainer>
    )
}
